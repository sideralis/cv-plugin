...
//		String cmd = "U:\\IFX_Tools\\gnu\\bin\\gnumake.exe -f " + prjLoc + "\\makefile.1";
//		String cmd = "gnumake.exe -f " + prjLoc + "\\makefile.1";
		String[] cmd = new String[] {".\\gnumake.exe"};//, "-f " + prjLoc + "\\makefile.1"};
//		List<String> cmd = new ArrayList<String>();
//		cmd.add("U:\\IFX_Tools\\gnu\\bin\\gnumake.exe");
//		cmd.add("-f " + prjLoc + "\\makefile.1");
		String[] env = new String[] {"PATH=U:\\IFX_Tools\\gnu\\bin"};
		try {
