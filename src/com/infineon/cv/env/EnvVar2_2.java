...
/**
 * EnvVar2_2 implements IConfigurationEnvironmentVariableSupplier interface
 * which offers the environment variables of RVDS 2.2 on the level of toolchain
 * configuration.It is The tool-integrator can provide Project-level and
 * Configuration-level environment variable suppliers separately.
 * */
public class EnvVar2_2 implements IConfigurationEnvironmentVariableSupplier {
